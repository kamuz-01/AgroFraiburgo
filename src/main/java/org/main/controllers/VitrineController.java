...
public class VitrineController {
    ...
    public String buscar(@RequestParam(required = false) String q,
        ...
        Page<Produto> produtosEncontradosPage = produtoRepository.buscarPorTermoEPreco(
                termo.isBlank() ? null : termo,
                precoMinimo,
                precoMaximo,
                PageRequest.of(0, 24));
        List<Produto> produtosEncontrados = produtosEncontradosPage.getContent();
        ...
        model.addAttribute("totalProdutosEncontrados", produtosEncontradosPage.getTotalElements());
        model.addAttribute("totalProdutoresEncontrados", produtoresEncontrados.size());
        model.addAttribute("hasMoreProdutosEncontrados", produtosEncontradosPage.hasNext());
