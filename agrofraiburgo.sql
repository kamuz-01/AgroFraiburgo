...
--
-- Host: 127.0.0.1
-- Tempo de geração: 16/05/2026 às 19:48
...
(5, '20260417.1', 'add login bruteforce protection', 'SQL', 'V20260417.1__add_login_bruteforce_protection.sql', 383133279, 'root', '2026-04-17 18:40:36', 518, 0);
...
--
-- Despejando dados para a tabela `login_ip_rate_limits`
--

INSERT INTO `login_ip_rate_limits` (`id_login_ip_rate_limit`, `ip_address`, `tentativas_na_janela`, `janela_inicio`, `bloqueado_ate`, `criado_em`, `atualizado_em`, `versao`) VALUES
(13, '0:0:0:0:0:0:0:1', 0, NULL, NULL, '2026-04-18 17:00:27', '2026-04-19 12:11:45', 9);
...
(3, 23, 'Pêssego', 'Fresco, natural, do seu jeito', 6, 'kg', 250, 'COM_ESTOQUE', '/imagens-usuarios/23/produtos/1759864944571_nisonco-pr-and-seo-H4QpChoce7I-u.png', '2025-10-07 16:22:25', '2026-05-15 17:31:10'),
...
INSERT INTO `recuperacao_senha_tokens` (`id_token`, `id_usuario`, `token`, `expira_em`, `usado_em`, `criado_em`, `ip_address`) VALUES
(4, 11, '63bf6faa-c58d-4ecf-83bf-0e299ee60670', '2026-04-12 22:04:22', '2026-05-16 14:44:55', '2026-04-12 21:04:22', NULL),
(5, 11, '51a6fafe-8f25-4df4-a1c6-42540a2b271a', '2026-05-16 15:44:55', NULL, '2026-05-16 14:44:55', '0:0:0:0:0:0:0:1');
...
(11, 'Pedro', 'Pérez', '04904699068', '2007-01-01', 'Masculino', '11111111111', 'pedro@yahoo.com', 'pedro', '$2a$10$3JpCUzGm4MkjxJjqjqRz/eRG3dmSaPVcuje8ci3F0/dBs.hoYjdVi', 'CONSUMIDOR', NULL, NULL, '2025-09-09 16:30:51', '2026-05-16 14:46:45', 'ATIVO', '/imagens-usuarios/11/imagem-perfil/perfil_1757446251436.png', '/imagens-usuarios/11/imagem-capa/capa_1757446251443.png', 'Fraiburgo', 'SC', 'LIVRE', 0, NULL),
(12, 'Jose', 'Torres', '24654075038', '2007-01-30', 'Masculino', '22222222222', 'jose@email.com', 'jose', '$2a$10$DwQhT8t7xu4OW5852Xua7OAtn1XShtocbUDnPP9ScYtxBcBzxkeOu', 'CONSUMIDOR', NULL, NULL, '2025-09-09 17:06:36', '2026-04-18 17:01:43', 'ATIVO', '/imagens-usuarios/12/imagem-perfil/perfil_1757448396543.png', '/imagens-usuarios/12/imagem-capa/capa_1757448396548.png', 'Fraiburgo', 'SC', 'LIVRE', 0, NULL),
...
(23, 'Antonia', 'Palacios', '36277330020', '2007-01-01', 'Feminino', '66666666666', 'antonia@email.com', 'antonia', '$2a$10$PF4s6TNND3tBr6gRM2GPb.6UkEniFU/cOqkaPajM2hWD7z97mkqRe', 'PRODUTOR', NULL, NULL, '2025-09-11 11:27:30', '2026-04-19 12:25:47', 'ATIVO', '/imagens-usuarios/23/imagem-perfil/perfil_1757600850694.png', '/imagens-usuarios/23/imagem-capa/capa_1757600850703.png', 'Fraiburgo', 'SC', 'LIVRE', 0, NULL),
...
ALTER TABLE `recuperacao_senha_tokens`
  ...
  ADD KEY `idx_recuperacao_senha_usuario_criado` (`id_usuario`,`criado_em`),
  ADD KEY `idx_recuperacao_senha_ip_criado` (`ip_address`,`criado_em`);
...
--
ALTER TABLE `login_ip_rate_limits`
  MODIFY `id_login_ip_rate_limit` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
